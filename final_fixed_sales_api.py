...
# -*- coding: utf-8 -*-
"""
最終修正版売上分析API - choice_infoカラムを使用
"""
...
def get_final_basic_sales_summary(start_date: str = None, end_date: str = None):
    """
    最終版: choice_infoカラムを使った基本売上集計
    """
    ...
    print(f"=== 最終版基本売上集計 ({start_date} ~ {end_date}) ===")
...
def get_final_choice_detail_analysis(start_date: str = None, end_date: str = None):
    """
    最終版: choice_infoカラムを使った選択肢詳細分析
    """
    supabase = create_client(SUPABASE_URL, SUPABASE_KEY)
    ...
    print(f"\n=== 最終版選択肢詳細分析 ({start_date} ~ {end_date}) ===")
...
if __name__ == "__main__":
    ...
    # 基本売上集計
    basic_result = get_final_basic_sales_summary('2025-08-01', '2025-08-04')
    
    # 選択肢詳細分析
    choice_result = get_final_choice_detail_analysis('2025-08-01', '2025-08-04')
    ...
    if basic_result['summary']['total_sales'] > 0:
        print("SUCCESS: choice_code_mappingテーブルを使った売上集計が成功しました！")
    else:
        print("NOTE: choice_code_mappingテーブルにR01, R12等のマッピングが登録されていない可能性があります")