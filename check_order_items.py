...
# Supabase接続
supabase_url = os.environ.get("SUPABASE_URL", "https://jvkkvhdqtotbotjzngcv.supabase.co")
supabase_key = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp2a2t2aGRxdG90Ym90anpuZ2N2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjIzOTk5NjAsImV4cCI6MjAzNzk3NTk2MH0.A64VUJBkQ-ePdQ5dX3hPQonpOBDiC73GHhxOKWj-1Zk")
